...
public class BlockWorkbenchEx extends Block {
	...
	public boolean onBlockActivated(World world, int i, int j, int k, EntityPlayer player, int l, float f, float f2,
			float f3) {
		   if(world.isRemote) {
			   player.openGui(Main.instance, 0, world, i, j, k);
		   }
		return true;
	}
	...
	public void registerIcons(IIconRegister register) {
		...
		this.top[0] = register.registerIcon("extraworkbench:wb_top");
		this.side = register.registerIcon("extraworkbench:wb_side");
	}
